...
fpga =casperfpga.CasperFpga('dsa-ata-snap-5')

mac_base0 = (2<<40) + (2<<32)
dest_macff= 255*(2**40) + 255*(2**32) + 255*(2**24) + 255*(2**16) + 255*(2**8) + 255
arp_table = [dest_macff for i in range(256)]

src_ip =  10*(2**24) + 10*(2**16) + 2*(2**8) + 165
src_ip0 =  10*(2**24) + 10*(2**16) + 2*(2**8) + 170+5 

src_mac = 0*(2**40) + 6*(2**32) + 171*(2**24) + 63*(2**16) + 23*(2**8) + 1
