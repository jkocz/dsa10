...
fpga =casperfpga.CasperFpga('dsa-ata-snap-2')

mac_base0 = (2<<40) + (2<<32)
dest_macff= 255*(2**40) + 255*(2**32) + 255*(2**24) + 255*(2**16) + 255*(2**8) + 255
arp_table = [dest_macff for i in range(256)]

src_ip =  10*(2**24) + 10*(2**16) + 2*(2**8) + 162
src_ip0 =  10*(2**24) + 10*(2**16) + 2*(2**8) + 170+2 

src_mac = 0*(2**40) + 17*(2**32) + 230*(2**24) + 211*(2**16) + 23*(2**8) + 1
